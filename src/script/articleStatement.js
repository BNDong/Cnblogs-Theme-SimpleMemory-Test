...
$(document).ready(function(){
    ...
    bottom_html += '<div style="width: 15%; float: left;"><img src="'+imgUrl+'" style="width: 80%; max-height: 80%; border: 1px solid #ccc; padding: 5px;"/></div>';

    // =============== 信息部分 ===============
    bottom_html += '<div style="width: 85%; float: right;">';
    ...
    bottom_html += '<a href="'+articleSource+'" target="_blank">'+author+'</a></span></strong> <br>';
    ...
    var aboutHtml = window.cnblogsConfig.essaySuffix.aboutHtml
        ...
        : '编程路上的小学生，热爱技术，喜欢专研。评论和私信会在第一时间回复。或者<a href="http://msg.cnblogs.com/msg/send/'+tmp[3]+'" target="_blank">直接私信</a>我。';

    bottom_html += '<span style="font-weight: bold; white-space:nowrap;">关于博主</span>：' + aboutHtml + '<br>';
    ...
    bottom_html += '<span style="font-weight: bold; white-space:nowrap;">版权声明</span>：' + copyrightHtml + '<br>';
    ...
    bottom_html += '<span style="font-weight: bold; white-space:nowrap;">声援博主</span>：' + supportHtml + '<br>';
